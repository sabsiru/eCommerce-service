...
@Component
public class CouponInventoryReader implements kr.hhplus.be.server.domain.coupon.CouponInventoryReader {
    ...
    public CouponInventoryReader(RedisTemplate<String, String> redisTemplate) {
